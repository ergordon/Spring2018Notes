...
process.J1 = (process.m/12)*(process.l2^2+process.l3^3);
process.J2 = (process.m/12)*(process.l3^2+process.l1^3);
process.J3 = (process.m/12)*(process.l1^2+process.l2^3);
