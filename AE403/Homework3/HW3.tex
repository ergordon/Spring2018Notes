...
\end{center}
\vspace{20mm}
For Homework 3 Problem 5 we are tasked with designing and simulating a spin-up manuever for a space-craft that is not axis-symmetric. In particular, consider a satellite with the principle moments of inertia:
\begin{equation*}
\begin{aligned}
J^2 = 
\begin{bmatrix}
