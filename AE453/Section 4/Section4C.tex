...
\begin{equation}
\begin{aligned}
\bar{c} = \int_{0}^{\infty} \, c \, \chi_m (c) \mathrm{d}c = (\frac{8 \, k \, T}{\pi \, m})^{\frac{1}{2}} = 1.13 c_{mp} \qquad \text{13 \% Higher}
\end{aligned}
...
\begin{equation}
\begin{aligned}
\sqrt{\bar{c}^2} = (\frac{3 \, k \, T}{m})^{\frac{1}{2}} = 1.22 \, c_{mp} \qquad \text{22 \% Higher}
\end{aligned}
