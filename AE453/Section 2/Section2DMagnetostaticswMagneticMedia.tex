...
\end{equation*}
\newline
If material is linear and isotropic, the magnetic susceptibility
is constant.
\newline
\begin{equation*}
\begin{aligned}
...
\end{equation*}
\newline
In a way entirely analogous to the electric susceptibility leading to $\vv{D} = \chi \, \vv{E}$
(2.39).
\begin{itemize}
...
\newline
\newline
Hiperco 50 (50-50 Co-Fe), also 30, 15 varieties (Co$\%$)
\newline
\newline
...
\newline
\newline
Curie Temp - temperature at which material loses its ferromagnetic
properties (becomes paramagnetic).
\begin{itemize}
\item Fe - 770$^{\circ}$ C
\item Co - 1130$^{\circ}$ C
\end{itemize}
Samarium Cobalt (SmCo) high-temp permanent magnets,
commonly found in EP systems, 300-500$^{\circ}$ C, 700$^{\circ}$ C Curie Temp
\newline
\newline
...
\end{equation*}
\newline
Substituting in the magnetic susceptibility (2.82), so that now:
\newline
\newline
...
\end{equation*}
\newline
And (as we did with permittivity) we can define relative
permeability as:
\newline
\begin{equation*}
\begin{aligned}
...
Similar to Electrostatic B.C.'s, can show that for a surface current
density,
\newline
\newline
And
...
Magnetic flux is the flux through a given surface. Units [Webers]
are the same as [T-m2] .
\newline
\newline
