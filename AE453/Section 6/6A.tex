...
\textbf{SAHA Equation}
     \begin{equation}
 \begin{aligned}
\frac{\alpha^2}{1-\alpha} = \beta (P,T)%the amount of ionization is dependtent on tepreature and pressure. Higher temp = more ionization, everything has more energy meaning the have more translational energy. Higher pressure = lower ionization becasue we get more 3-body recombinations.
 \end{aligned}
 \end{equation}
where
